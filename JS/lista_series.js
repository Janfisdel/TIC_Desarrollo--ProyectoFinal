let series = [
...

  {
    ...
    plataforma: "https://res.cloudinary.com/janfis/image/upload/v1641573201/Mujeres%20TIC/plataformas/HBO_Max_Logo_okcip1.svg",
  ...
  },
  {
    ...
    calificacion: 8.1,
    actores: "Michael Cimino, Anthony Turpel, George Sear, Rachel Hilson, Nick Robinson ",
    plataforma: "https://res.cloudinary.com/janfis/image/upload/v1641572325/Mujeres%20TIC/plataformas/Star__logo_ok4zpc.svg",
...

  {
    ...
    plataforma: "https://res.cloudinary.com/janfis/image/upload/v1641573531/Mujeres%20TIC/plataformas/Disney__logo_okpcii.svg",
  ...
  },
 {
  ...
  },
  {
    ...
    plataforma: "https://res.cloudinary.com/janfis/image/upload/v1641916318/Mujeres%20TIC/plataformas/Paramount_Plus.svg_y8adfh.png",
  ...
  },
{
  ...
  Categoria: "Policial",
  temporadas: 2,
  descripcion: "Inspirado por un libro sobre el caballero ladrón Arsène Lupin que su padre le había regalado en su cumpleaños, Assane se propone vengarse de la familia que incriminó a su padre, utilizando su carisma y dominio del robo, el subterfugio y el disfraz",
  calificacion: 7.5,
...
},
{
  ...
  categoria: "Romance",
  temporadas: 2,
  descripcion: "Explora el amor en su multitud de formas, que incluyen el amor sexual, romántico, familiar, platónico y propio. Esta serie basada en la columna del mismo nombre del New York Times, adapta diferentes historias de amor que tienen lugar en la ciudad de Nueva York.",
  calificacion: 8.0,
...
},
{
  ...
  categoria: "Ciencia ficción",
  temporadas: 1,
  descripcion: "Después de robar el Tesseract durante los eventos de Avengers: Endgame, una versión alternativa de Loki es llevada a la misteriosa TVA, una organización burocrática que existe fuera del tiempo y el espacio y monitorea la línea de tiempo. Le dan a Loki dos opciones: enfrentarse a ser borrado de la existencia debido a que es una variante de tiempo, o ayudar a arreglar la línea de tiempo y detener una amenaza mayor.",
  calificacion: 8.3,
...
},
{
  ...
  categoria: "Drama",
  temporadas: 2,
  descripcion:"La serie sigue a un grupo de estudiantes de secundaria, que sumergidos en el fatídico mundo de las drogas, el sexo y la violencia tratan de luchar contra esos monstruos para enfrentarse a un nuevo futuro",
  calificacion: 8.4,
